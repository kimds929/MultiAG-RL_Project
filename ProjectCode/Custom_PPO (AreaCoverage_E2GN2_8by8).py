...
raw_env = AreaCoverage.parallel_env(grid_size=(8,8), num_agents=3, 
                       obstacle_spec="random", max_cycles=1000,
...
checkpoint_path = '/home/kimds929/CodePractice/AreaCoverageE2GN2_8by8'
...
for i in range(N_ITER):
    ...
    if (i % 5 == 0) or (i == N_ITER-1):
        save_path = f"/home/kimds929/CodePractice/AreaCoverageE2GN2_8by8"
