...
class MultiAgentWrapper(gym.Env):
    ...
    def step(self, action):
        ...
        # if rewards[self.agents[0]] != rewards[self.agents[1]] or rewards[self.agents[1]] != rewards[self.agents[2]] or rewards[self.agents[0]] != rewards[self.agents[2]]:
        #     print(f'diff: {rewards}')
        # else:
        #     pass
