...
checkpoint_path = '/home/kimds929/CodePractice/AreaCoverageE2GN2_embdim8'
if "ppo_decentalize_checkpoint.zip" in os.listdir(checkpoint_path):
    ...
    # PPO 정책 정의
    policy_kwargs = dict(embed_dim=8, msg_dim=32)
...
# np.array(dir(model.policy.custom_model))[-100:]
# model.policy.custom_model.actor_net
...
for i in range(N_ITER):
    ...
    if (i % 5 == 0) or (i == N_ITER-1):
        save_path = f"/home/kimds929/CodePractice/AreaCoverageE2GN2_embdim8"
